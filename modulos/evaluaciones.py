...
with tab_alumnos:
    ...
    if sim_activo:
        ...
        st.info("🔒 **Simulador Institucional:** BLOQUEADO (Se activará conforme avances de módulo)")
...
if es_admin:
    ...
    with tab_permisos:
        ...
        if alumno_mat_permiso:
            ...
            st.markdown(f"#### Configurando Módulos y Herramientas para: `{alumno_mat_permiso}`")
            ...
            with st.form("form_permisos_alumno"):
                ...
                check_sim = st.checkbox(
                    ...
                    value=("Simulador Institucional" in permisos_actuales_alumno)
                )
                if check_sim:
            ...
            if target_resp:
                ...
                with col_d2:
                    with st.form("form_dictamen_admin"):
                        ...
                        st.markdown("---")
                        st.markdown("📜 **Adjuntar Reconocimiento Oficial (PDF, PNG, JPG):**")
