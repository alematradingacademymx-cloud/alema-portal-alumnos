...
def render_simulador():
    ...
    def obtener_cotizacion_completa(simbolo):
        ...
        simbolos_map = {
            ...
            "XAUUSD": "XAU/USD", "WTIUSD": "WTI/USD", "BRENTUSD": "BRENT/USD",
            "US30": "US30", "SPX500": "SPX", "NAS100": "NDX", "GER40": "DAX", "BTCUSD": "BTC/USD"
        }
        ...
        if simbolo in st.session_state.cache_precios_forex:
            ...
            precios_fallback = {
                "EURUSD": 1.15919, "GBPUSD": 1.31210, "USDJPY": 146.850, "EURJPY": 162.450,
                "XAUUSD": 2512.30, "US30": 41200.00, "BTCUSD": 62500.00
            }
...
render_simulador_live = render_simulador
